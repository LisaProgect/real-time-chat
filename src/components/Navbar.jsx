...
const Navbar = () => {
    ...
    return (
        <nav className="lg:sticky top-0 z-40 fixed w-full backdrop-blur  flex-none transition-colors duration-500 lg:z-50 lg:border-b lg:border-slate-900/10 dark:border-slate-50/[0.06] bg-white/95 dark:bg-transparent">
